    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div 
          ...
          className="gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 border-l-[#38BDF8]"
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-[#102444] text-[#38BDF8] flex items-center justify-center group-hover:scale-105 transition-transform shadow-xs border border-[#1E3D6B]">
              <Boxes className="w-6 h-6" />
            </div>
            <span className="text-xs px-2.5 py-1 rounded-full bg-[#0C2447] text-[#60A5FA] font-bold border border-[#1E4B8A]">
              Total Activos
            </span>
          </div>
          ...
          <div className="pt-3 border-t border-[#1E3352]/60 space-y-1.5 text-xs text-slate-300">
            <div className="flex justify-between font-semibold">
              <span className="text-[#38BDF8]">Propios: {ownAssetsCount} ({ownPercentage}%)</span>
              <span className="text-slate-400">Arriendo: {leasingAssetsCount}</span>
            </div>
            <div className="w-full h-1.5 bg-[#0C1729] rounded-full overflow-hidden flex">
              <div style={{ width: `${ownPercentage}%` }} className="bg-[#0055A5] h-full" />
        ...
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-emerald-950/80 text-emerald-400 flex items-center justify-center group-hover:scale-105 transition-transform shadow-xs border border-emerald-700/60">
              <Laptop className="w-6 h-6" />
            </div>
            <span className="text-xs px-2.5 py-1 rounded-full bg-emerald-950/80 text-emerald-300 font-bold border border-emerald-700/60">
              En Bodega
            </span>
          </div>
          ...
          <div className="pt-3 border-t border-[#1E3352]/60 flex items-center justify-between text-xs font-semibold">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-indigo-950/80 text-indigo-400 flex items-center justify-center group-hover:scale-105 transition-transform shadow-xs border border-indigo-700/60">
              <FileCheck2 className="w-6 h-6" />
            </div>
            <span className="text-xs px-2.5 py-1 rounded-full bg-indigo-950/80 text-indigo-300 font-bold border border-indigo-700/60">
              Operativos
            </span>
          </div>
          ...
          <div className="pt-3 border-t border-[#1E3352]/60 flex items-center justify-between text-xs text-slate-300 font-semibold">
            <span className="text-slate-400">
              {maintenanceCount > 0 ? `${maintenanceCount} en mantención técnica` : '0 en servicio técnico'}
            </span>
            <span className="text-[#38BDF8] group-hover:underline flex items-center gap-0.5">
        ...
        <div 
          ...
          className={`gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 ${
            expiringContracts.length > 0 ? 'border-l-amber-500' : 'border-l-slate-600'
          }`}
        >
          <div className="flex items-center justify-between">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform shadow-xs border ${
              expiringContracts.length > 0 ? 'bg-amber-950/80 text-amber-400 border-amber-700/60' : 'bg-slate-800 text-slate-400 border-slate-700'
            }`}>
              <Clock className="w-6 h-6" />
            </div>
            <span className={`text-xs px-2.5 py-1 rounded-full font-bold border ${
              expiringContracts.length > 0 ? 'bg-amber-950/80 text-amber-300 border-amber-700/60' : 'bg-slate-800 text-slate-300 border-slate-700'
            }`}>
          ...
          <div className="pt-3 border-t border-[#1E3352]/60 flex items-center justify-between text-xs text-slate-300 font-semibold">
            <span className={expiringContracts.length > 0 ? 'text-amber-400 font-bold' : 'text-slate-400'}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div
          onClick={() => onNavigate('assignments')}
          className="gov-card p-4 flex items-center gap-3 cursor-pointer hover:border-[#38BDF8] hover:shadow-md transition-all group"
        >
          <div className="w-10 h-10 rounded-xl bg-[#102444] text-[#38BDF8] flex items-center justify-center shrink-0 group-hover:bg-[#003B70] group-hover:text-white transition-colors border border-[#1E3D6B]">
            <FileCheck2 className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-white truncate">Asignar Equipos</h4>
            <p className="text-[11px] text-slate-400 truncate">Generar acta oficial</p>
          </div>
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-emerald-950/80 text-emerald-400 flex items-center justify-center shrink-0 group-hover:bg-emerald-700 group-hover:text-white transition-colors border border-emerald-700/60">
            <PackageCheck className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-white truncate">Recepción OC</h4>
            <p className="text-[11px] text-slate-400 truncate">Ingreso de hardware</p>
          </div>
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-purple-950/80 text-purple-400 flex items-center justify-center shrink-0 group-hover:bg-purple-700 group-hover:text-white transition-colors border border-purple-700/60">
            <Layers className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-white truncate">Insumos y Stock</h4>
            <p className="text-[11px] text-slate-400 truncate">Bodega de repuestos</p>
          </div>
        </div>
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-cyan-950/80 text-cyan-400 flex items-center justify-center shrink-0 group-hover:bg-cyan-700 group-hover:text-white transition-colors border border-cyan-700/60">
            <Users2 className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-white truncate">Directorio AD</h4>
            <p className="text-[11px] text-slate-400 truncate">3400+ Funcionarios</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="gov-card p-5 sm:p-6 space-y-4">
          <div className="flex items-center justify-between pb-3.5 border-b border-[#1E3352]/60">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#102444] text-[#38BDF8] flex items-center justify-center border border-[#1E3D6B]">
                <Laptop className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-white">Distribución por Tipo de Hardware</h3>
                <p className="text-xs text-slate-400">Composición del inventario informático</p>
              </div>
            </div>
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-[#0C1729] text-slate-300 border border-[#1E3352]">
                ...
                return (
                  <div key={typeName} className="space-y-1.5">
                    <div className="flex justify-between text-xs sm:text-sm">
                      ...
                      <span className="font-mono font-bold text-white">{count} un. <span className="text-slate-400 font-normal">({percentage}%)</span></span>
                    </div>
                    <div className="w-full h-2.5 bg-[#0C1729] rounded-full overflow-hidden border border-[#1E3352]/40">
                      <div
        ...
        <div className="gov-card p-5 sm:p-6 space-y-4">
          <div className="flex items-center justify-between pb-3.5 border-b border-[#1E3352]/60">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-red-950/80 text-[#F87171] flex items-center justify-center border border-red-700/60">
                <ShieldAlert className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-white">Alertas de Stock & Vencimientos</h3>
                <p className="text-xs text-slate-400">Notificaciones prioritarias para gestión de bodega</p>
              </div>
            </div>
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-red-950/80 text-[#F87171] border border-red-700/60">
          ...
          <div className="space-y-3 pt-1">
            {expiringContracts.length === 0 && criticalStockItems.length === 0 ? (
              <div className="py-8 text-center text-slate-400 space-y-2">
                ...
                <p className="text-sm font-bold text-slate-200">Inventario y Contratos al Día</p>
              ...
              <>
                ...
                {expiringContracts.map(c => (
                  <div key={c.id} className="p-3.5 rounded-xl bg-amber-950/40 border border-amber-800/60 flex items-center justify-between gap-3 text-xs">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-white">{c.contractNumber}</span>
                        <span className="font-semibold text-slate-300">({c.supplierName})</span>
                      </div>
                      <p className="text-slate-300 mt-0.5">{c.name}</p>
                      <div className="text-slate-400 mt-1 flex items-center gap-2">
                        <span>Vence: <strong className="text-amber-300">{formatDate(c.endDate)}</strong></span>
                        <span>•</span>
                        <span>{c.linkedAssetsCount} equipos asociados</span>
                      </div>
                    </div>
                    <div className="shrink-0 text-right">
                      <span className="px-2.5 py-1 rounded-md bg-amber-900/80 text-amber-300 font-bold border border-amber-600/70">
                        {c.daysLeft} días
                      </span>
                    </div>
                  </div>
                ...
                {criticalStockItems.map((item: any) => (
                  <div key={item.id} className="p-3.5 rounded-xl bg-red-950/40 border border-red-800/60 flex items-center justify-between gap-3 text-xs">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-white">{item.consumableName}</span>
                        <span className="font-mono text-[11px] px-1.5 py-0.5 rounded bg-[#0C1729] text-slate-200 border border-[#1E3352] font-semibold">
                          {item.sku}
                        </span>
                      </div>
                      <p className="text-slate-400 mt-1">{item.branchName}</p>
                    </div>
                    <div className="shrink-0 text-right">
                      <div className="font-bold text-[#F87171] text-sm">{item.currentQuantity} un. disp.</div>
                      <span className="text-slate-400 text-[11px]">Mín: {item.minAlert} un.</span>
                    </div>
                  </div>
                ))}
              </>
      ...
      <div className="gov-card p-5 sm:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3.5 border-b border-[#1E3352]/60">
          <div>
            <h3 className="text-base font-bold text-white">Actividad y Trazabilidad Reciente</h3>
            <p className="text-xs text-slate-400">Registro inmutable de movimientos, asignaciones y cambios de estado</p>
          </div>

          <button
            onClick={() => onNavigate('traceability')}
            className="text-xs sm:text-sm text-[#38BDF8] hover:text-white font-bold flex items-center gap-1 hover:underline"
          >
          ...
          {auditLogs.length === 0 ? (
            ...
            auditLogs.map((log: any) => (
              <div 
                key={log.id} 
                onClick={() => onNavigate('traceability')}
                className="p-3.5 rounded-xl bg-[#0D182B] hover:bg-[#14233C] border border-[#1E3352] transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs sm:text-sm cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#38BDF8] shrink-0 shadow-xs" />
                  <div>
                    <div className="font-bold text-white flex items-center gap-2">
                      <span>Serie: {log.serialNumber}</span>
                      {log.inventoryNumber && (
                        <span className="text-xs font-mono px-2 py-0.5 rounded bg-[#0C2447] text-[#60A5FA] font-bold border border-[#1E4B8A]">
                          Inv: {log.inventoryNumber}
                        </span>
                      )}
                    </div>
                    <p className="text-xs text-slate-400 mt-0.5">{log.changeReason}</p>
                  </div>
                </div>
