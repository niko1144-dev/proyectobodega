    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div 
          ...
          className="gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 border-l-[#003B70]"
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-blue-50 text-[#003B70] flex items-center justify-center group-hover:scale-105 transition-transform shadow-2xs">
              <Boxes className="w-6 h-6" />
            </div>
            <span className="text-xs px-2.5 py-1 rounded-full bg-blue-50 text-[#003B70] font-bold border border-blue-200">
              Total Activos
            </span>
          </div>
          ...
          <div className="pt-3 border-t border-slate-100 space-y-1.5 text-xs text-slate-600">
            <div className="flex justify-between font-semibold">
              <span className="text-[#003B70]">Propios: {ownAssetsCount} ({ownPercentage}%)</span>
              <span className="text-slate-500">Arriendo: {leasingAssetsCount}</span>
            </div>
            <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden flex">
              <div style={{ width: `${ownPercentage}%` }} className="bg-[#003B70] h-full" />
        ...
        <div 
          onClick={() => onNavigate('inventory')}
          className="gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 border-l-emerald-600"
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-emerald-50 text-emerald-700 flex items-center justify-center group-hover:scale-105 transition-transform shadow-2xs">
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-semibold">
            ...
            <span className="text-slate-400 group-hover:text-slate-700 transition-colors flex items-center gap-0.5">
        ...
        <div 
          onClick={() => onNavigate('assignments')}
          className="gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 border-l-blue-600"
        >
          <div className="flex items-center justify-between">
            <div className="w-12 h-12 rounded-xl bg-indigo-50 text-indigo-700 flex items-center justify-center group-hover:scale-105 transition-transform shadow-2xs">
              <FileCheck2 className="w-6 h-6" />
            </div>
            <span className="text-xs px-2.5 py-1 rounded-full bg-indigo-50 text-indigo-800 font-bold border border-indigo-200">
              Operativos
            </span>
          </div>
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-600 font-semibold">
            ...
            <span className="text-[#003B70] group-hover:underline flex items-center gap-0.5">
        ...
        <div 
          ...
          className={`gov-card p-5 sm:p-6 space-y-3 cursor-pointer hover:shadow-gov-card hover:-translate-y-0.5 transition-all group border-l-4 ${
            expiringContracts.length > 0 ? 'border-l-amber-500' : 'border-l-slate-400'
          }`}
        >
          <div className="flex items-center justify-between">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform shadow-2xs ${
              expiringContracts.length > 0 ? 'bg-amber-50 text-amber-700' : 'bg-slate-100 text-slate-600'
            }`}>
              <Clock className="w-6 h-6" />
            </div>
            <span className={`text-xs px-2.5 py-1 rounded-full font-bold border ${
              expiringContracts.length > 0 ? 'bg-amber-50 text-amber-800 border-amber-200' : 'bg-slate-100 text-slate-600 border-slate-200'
            }`}>
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-600 font-semibold">
            <span className={expiringContracts.length > 0 ? 'text-amber-700 font-bold' : 'text-slate-500'}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div
          onClick={() => onNavigate('assignments')}
          className="gov-card p-4 flex items-center gap-3 cursor-pointer hover:border-[#003B70] hover:shadow-md transition-all group"
        >
          <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#003B70] flex items-center justify-center shrink-0 group-hover:bg-[#003B70] group-hover:text-white transition-colors">
            <FileCheck2 className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-slate-900 truncate">Asignar Equipos</h4>
            <p className="text-[11px] text-slate-500 truncate">Generar acta oficial</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-slate-900 truncate">Recepción OC</h4>
            <p className="text-[11px] text-slate-500 truncate">Ingreso de hardware</p>
          </div>
        </div>
        ...
        <div
          ...
          className="gov-card p-4 flex items-center gap-3 cursor-pointer hover:border-[#003B70] hover:shadow-md transition-all group"
        >
          <div className="w-10 h-10 rounded-xl bg-purple-50 text-purple-700 flex items-center justify-center shrink-0 group-hover:bg-purple-700 group-hover:text-white transition-colors">
            <Layers className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-slate-900 truncate">Insumos y Stock</h4>
            <p className="text-[11px] text-slate-500 truncate">Bodega de repuestos</p>
          </div>
        </div>
        ...
        <div
          ...
          className="gov-card p-4 flex items-center gap-3 cursor-pointer hover:border-[#003B70] hover:shadow-md transition-all group"
        >
          <div className="w-10 h-10 rounded-xl bg-cyan-50 text-cyan-700 flex items-center justify-center shrink-0 group-hover:bg-cyan-700 group-hover:text-white transition-colors">
            <Users2 className="w-5 h-5" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs sm:text-sm font-bold text-slate-900 truncate">Directorio AD</h4>
            <p className="text-[11px] text-slate-500 truncate">1800+ Funcionarios</p>
          </div>
        </div>
        ...
        <div className="gov-card p-5 sm:p-6 space-y-4">
          <div className="flex items-center justify-between pb-3.5 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#003B70] flex items-center justify-center">
                <Laptop className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900">Distribución por Tipo de Hardware</h3>
                <p className="text-xs text-slate-500">Composición del inventario informático</p>
              </div>
            </div>
                ...
                return (
                  <div key={typeName} className="space-y-1.5">
                    <div className="flex justify-between text-xs sm:text-sm">
                      ...
                      <span className="font-mono font-bold text-slate-900">{count} un. <span className="text-slate-400 font-normal">({percentage}%)</span></span>
                    </div>
        ...
        <div className="gov-card p-5 sm:p-6 space-y-4">
          <div className="flex items-center justify-between pb-3.5 border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900">Alertas de Stock & Vencimientos</h3>
                <p className="text-xs text-slate-500">Notificaciones prioritarias para gestión de bodega</p>
              </div>
            </div>
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-red-50 text-[#E4002B] border border-red-200">
          ...
          <div className="space-y-3 pt-1">
            {expiringContracts.length === 0 && criticalStockItems.length === 0 ? (
              <div className="py-8 text-center text-slate-400 space-y-2">
                ...
                <p className="text-sm font-bold text-slate-700">Inventario y Contratos al Día</p>
                <p className="text-xs text-slate-400">No se detectan alertas críticas de stock ni arriendos próximos a vencer.</p>
              </div>
            ) : (
              <>
                {/* Contratos por vencer */}
                {expiringContracts.map(c => (
                  <div key={c.id} className="p-3.5 rounded-xl bg-amber-50/70 border border-amber-200 flex items-center justify-between gap-3 text-xs">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-slate-900">{c.contractNumber}</span>
                        <span className="font-semibold text-slate-600">({c.supplierName})</span>
                      </div>
                      <p className="text-slate-700 mt-0.5">{c.name}</p>
                      <div className="text-slate-500 mt-1 flex items-center gap-2">
                        <span>Vence: <strong>{formatDate(c.endDate)}</strong></span>
                        <span>•</span>
                ...
                {criticalStockItems.map((item: any) => (
                  <div key={item.id} className="p-3.5 rounded-xl bg-red-50/70 border border-red-200 flex items-center justify-between gap-3 text-xs">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-slate-900">{item.consumableName}</span>
                        <span className="font-mono text-[11px] px-1.5 py-0.5 rounded bg-white text-slate-700 border border-slate-200 font-semibold">
                          {item.sku}
                        </span>
                      </div>
                      <p className="text-slate-500 mt-1">{item.branchName}</p>
                    </div>
                    <div className="shrink-0 text-right">
                      <div className="font-bold text-[#E4002B] text-sm">{item.currentQuantity} un. disp.</div>
                      <span className="text-slate-500 text-[11px]">Mín: {item.minAlert} un.</span>
                    </div>
                  </div>
                ))}
              </>
      ...
      <div className="gov-card p-5 sm:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3.5 border-b border-slate-100">
          <div>
            <h3 className="text-base font-bold text-slate-900">Actividad y Trazabilidad Reciente</h3>
            <p className="text-xs text-slate-500">Registro inmutable de movimientos, asignaciones y cambios de estado</p>
          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-slate-900 flex items-center gap-2">
                      ...
                      {log.inventoryNumber && (
                        <span className="text-xs font-mono px-2 py-0.5 rounded bg-blue-50 text-[#003B70] font-bold border border-blue-200">
                          Inv: {log.inventoryNumber}
                        </span>
                      )}
                    </div>
                    <p className="text-xs text-slate-600 mt-0.5">{log.changeReason}</p>
                  </div>
                </div>
